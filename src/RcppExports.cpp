...
RcppExport SEXP _GpGp_exponential_anisotropic(SEXP covparmsSEXP, SEXP locsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type covparms(covparmsSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type locs(locsSEXP);
    rcpp_result_gen = Rcpp::wrap(exponential_anisotropic(covparms, locs));
    return rcpp_result_gen;
END_RCPP
}
// d_exponential_anisotropic
arma::cube d_exponential_anisotropic(arma::vec covparms, arma::mat locs);
RcppExport SEXP _GpGp_d_exponential_anisotropic(SEXP covparmsSEXP, SEXP locsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type covparms(covparmsSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type locs(locsSEXP);
    rcpp_result_gen = Rcpp::wrap(d_exponential_anisotropic(covparms, locs));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_GpGp_exponential_anisotropic", (DL_FUNC) &_GpGp_exponential_anisotropic, 2},
    {"_GpGp_d_exponential_anisotropic", (DL_FUNC) &_GpGp_d_exponential_anisotropic, 2},
